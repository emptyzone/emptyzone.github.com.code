...
module Jekyll
  ...
  class Site
    ...
    #  +category+     is the category currently being processed.
    def write_tag_index(category_dir, category)
      index = TagIndex.new(self, self.source, category_dir, category)
    ...
    def write_tag_indexes
      if self.layouts.key? 'tag_index'
        ...
        self.tags.keys.each do |category|
          self.write_tag_index(File.join(dir, category), category)
        end
